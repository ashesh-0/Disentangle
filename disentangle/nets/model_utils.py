...
from disentangle.nets.lvae_withCL import LadderVAEwithCL
...
def create_model(config, data_mean, data_std):
    ...
    elif config.model.model_type == ModelType.LadderVaeCL:
        model = LadderVAEwithCL(data_mean, data_std, config)
    else:
