...
from disentangle.data_loader.bsd68_rawdata_loader import get_train_val_data as _loadbsd68
...
def get_train_val_data(data_config,
    ...
    if data_config.data_type == DataType.OptiMEM100_014:
        ...
        return _load_ht_iba1_ki67(fpath,
                                  ...
                                  val_fraction=val_fraction,
                                  test_fraction=test_fraction)
    elif data_config.data_type == DataType.BSD68:
        return _loadbsd68(fpath, data_config, datasplit_type, val_fraction=val_fraction, test_fraction=test_fraction)
