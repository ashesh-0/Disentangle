    ...
    def forward(self,
        ...
        if q_params is not None:
            ...
            if mode_pred is False:  # if not predicting
                ...
                kl_analytical = kl_elementwise = kl_samplewise = kl_spatial_analytical = kl_channelwise = None
        else:
            kl_elementwise = kl_samplewise = kl_spatial_analytical = kl_channelwise = None
            logprob_q = None
