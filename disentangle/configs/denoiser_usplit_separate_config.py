...
def get_config():
    ...
    data.num_channels = 3
    data.ch1_fname = 'pred_disentangle_2402_D3-M23-S0-L0_9.tif'
    data.ch2_fname = 'pred_disentangle_2402_D3-M23-S0-L0_8.tif'
    data.ch_input_fname = 'pred_disentangle_2402_D3-M23-S0-L0_13.tif'
