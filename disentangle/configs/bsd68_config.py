...
def get_config():
    ...
    fname_format = '/home/ashesh.ashesh/training/noise_model/2307/44/GMMNoiseModel_ventura_gigascience-DCNN400_train_gaussian25.npy_3_2_Clip0.0-0.995_Sig60.0_UpNone_Norm0_bootstrap.npz'
