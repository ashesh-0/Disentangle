...
def get_config():
    ...
    fname_format = '/home/ashesh.ashesh/training/noise_model/2307/38/GMMNoiseModel_ventura_gigascience-DCNN400_train_gaussian25.npy_12_4_Clip0.0-0.995_Sig0.5_UpNone_Norm1_bootstrap.npz'
