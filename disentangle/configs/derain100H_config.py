...
def get_config():
    ...
    fname = '/home/ubuntu.ubuntu/training/noise_model/2403/139/GMMNoiseModel_BioSR-__6_4_Clip0.0-1.0_Sig0.125_UpNone_Norm0_bootstrap.npz'
    ...
    training.lr = 0.001
    training.lr_scheduler_patience = 100
    training.max_epochs = 1600
    ...
    training.earlystop_patience = 800
