...
def get_config():
    ...
    model.noise_model_ch1_fpath = '/home/ashesh.ashesh/training/noise_model/2403/10/GMMNoiseModel_ventura_gigascience-actin_mito_6_4_Clip0.0-1.0_Sig0.125_Uone_Norm0_bootstrap.npz'
