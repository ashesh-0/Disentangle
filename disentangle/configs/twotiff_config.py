...
def get_config():
    ...
    fname_format = '/home/ashesh.ashesh/training/noise_model/{}/GMMNoiseModel_ventura_gigascience-{}_20_4_Clip0.0-0.995_Sig0.25_UpNone_Norm1_bootstrap.npz'
    model.noise_model_ch1_fpath = fname_format.format('2307/52', 'actin')
    model.noise_model_ch2_fpath = fname_format.format('2307/53', 'mito')
