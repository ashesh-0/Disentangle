...
def get_config():
    ...
    data.multiscale_highres_count = None
    ...
    model.logvar_higherbound = -5  # -2.49 is log(1/12), from paper "Re-parametrizing VAE for stablity."
    model.multiscale_highres_separate_branch = False
