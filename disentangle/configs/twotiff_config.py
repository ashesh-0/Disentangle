...
def get_config():
    ...
    fname_format = '/home/ashesh.ashesh/training/noise_model/{}/GMMNoiseModel_ventura_gigascience-{}_6_4_Clip0.0-0.995_Sig1.0_UpNone_Norm1_bootstrap.npz'
    model.noise_model_ch1_fpath = fname_format.format('2307/51', 'actin')
    model.noise_model_ch2_fpath = fname_format.format('2307/50', 'mito')
