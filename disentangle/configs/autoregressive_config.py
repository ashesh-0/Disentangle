...
def get_config():
    ...
    data.innerpad_amount = (data.image_size-data.val_grid_size)//2 # how many pixel predictions should be ignored while computing the full prediction for the frame.
