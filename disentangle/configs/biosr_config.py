...
def get_config():
    ...
    model.noise_model_type = 'deepgmm'
    fname = '/home/ashesh.ashesh/training/noise_model/2404/11/GMMNoiseModel_ventura_gigascience-__6_4_Clip0.0-1.0_Sig1e-07_UpNone_Norm0_bootstrap.npz'
