...
def get_config():
    ...
    model.predict_logvar = None #'channelwise'
    ...
    fname = '/home/ashesh.ashesh/training/noise_model/2404/3/GMMNoiseModel_ventura_gigascience-__6_4_Clip0.0-1.0_Sig0.125_UpNone_Norm0_bootstrap.npz'
