...
def get_config():
    ...
    config.data.synthetic_gaussian_scale = 152
    ...
    model.noise_model_ch1_fpath = fname_format.format('2402/239')
    model.noise_model_ch2_fpath = fname_format.format('2402/243')
