...
flags.DEFINE_string("logdir", '/group/ubuntu/ubuntu/wandb_backup/', "The folder name for storing logging")
flags.DEFINE_string("datadir", '/tmp2/ubuntu/ubuntu/VAE_based/data/MNIST/noisy/', "Data directory.")
